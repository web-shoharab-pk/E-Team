...
const MessageBoard = ({handleChatList}: IProps) : JSX.Element => {
    const [chatId, setChatId] = useState<any>('');
    
    const handleChatBoard = (id:any) => {
        setChatId(id);
    }
            ...
            <div className="relative">
                <div className="shadow fixed bg-white bottom-0 right-9 w-5/12 rounded-lg px-5 py-3">
                    <div className="relative">
                        ...
                        <p className="">
                            <FontAwesomeIcon onClick={() => handleChatList(false)} className="cursor-pointer absolute top-2 right-0" icon={faMinus} />
                        </p>
                    </div>
                    ...
                    <div className="mt-5 mb-12 h-1/2 overflow-y-scroll">
                        <div onClick={() => handleChatBoard('1')} className="flex cursor-pointer border-b py-3">

        ...
        <div className="loginArea container mx-auto">
            <div className="flex w-full justify-center">
                <div className="w-full xl:w-3/4 mt-14 lg:w-11/12 flex justify-between">
                    <div className="w-2/4 my-5 h-auto hidden lg:block lg:w-1/2 bg-cover rounded-l-lg" >
                        <img src={loginBG} alt="" />
                    </div>

                    <div className="loginFrom md:w-1/2 max-w-lg mx-auto my-5 px-4 py-5 shadow-2xl rounded-lg lg:rounded-l-none">
                        <div className="mt-5">
            ...
            <div className="footer-in-login text-center my-4">
                <ul className="text-sm font-medium">
                    <li className="inline-block mx-3 text-blue-600">
                        <Link to="/">E-Team Manage</Link>
                    </li>
                    -

    ...
    <div>
      <div className="shadow-lg mx-5 mt-4 px-7 py-5 pt-2 rounded-lg">
        ...
        <div className="pt-2">
          ...
          <div className="flex px-5 py-5 flex-row-reverse">
            <span className="inline-flex items-center bg-gray-200">
              <i className="fas fa-search"></i>
            </span>
            <input
              type="search"
              className="border px-5 outline-none py-1 rounded-3xl"
              name=""
              id=""
              ...
              <table className="w-full">
                <thead>
                  <tr className="text-left">
                    <th className="bg-blue-100 border px-10 py-4">Name</th>
                    <th className="bg-blue-100 border px-10 py-4">Team</th>
                    <th className="bg-blue-100 border px-10 py-4">
                      Observation
                    </th>
                    <th className="bg-blue-100 border px-10 py-4">
                      Starting-Ending Date
                    </th>
                    <th className="bg-blue-100 border px-10 py-4">Status</th>
                ...
                <tbody>
                  {meetingList.map((meeting) => (
                    <tr className="mb-3">
                      <td className="border-b-2 border-gray-300 px-10 py-4">
                        {meeting.Name}
                      </td>
                      <td className="border-b-2 border-gray-300 px-10 py-4">
                        {meeting.Team}

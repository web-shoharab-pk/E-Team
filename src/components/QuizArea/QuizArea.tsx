        ...
        <>
            ...
            <div className="mt-6">
                <div className="flex items-center">
                    <h1 className="w-1/2 text-3xl ml-10 font-bold">Quiz: How to email in professional way</h1>
                ...
                <div className="flex mt-8 ml-16 space-x-10">
                    <div className="w-2/3 shadow rounded-xl p-10">
                        <h4 className="text-center font-bold mb-4">1/5</h4>
                        <p className="text-lg font-semibold">In Publishing graphic design, Lorem ipsum is a placeholder tet commonly used to demonstrate the visual form of a document or a typeface without?</p>
                    
                        <div className="mt-6 mx-8">
                            <div className="flex justify-between mb-5">
                                <button className="w-5/12 cursor-pointer border text-lg border-blue-500 font-semibold py-2 rounded-lg">Something 01</button>
                                <button className="w-5/12 cursor-pointer border text-lg border-blue-500 font-semibold py-2 rounded-lg">Something 02</button>
                            </div>

                            <div className="flex justify-between mb-5">
                                <button className="w-5/12 cursor-pointer border text-lg border-blue-500 font-semibold py-2 rounded-lg">Something 03</button>
                                <button className="w-5/12 cursor-pointer border text-lg border-blue-500 font-semibold py-2 rounded-lg">Something 04</button>
                            </div>
                        </div>

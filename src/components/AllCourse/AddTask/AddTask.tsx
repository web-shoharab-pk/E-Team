        ...
        <div className="mt-6">
            <form action="" className="mx-6">
                <div className="lg:w-full text-left">
                    ...
                    <br />
                    <textarea className="border w-full py-3 px-4 focus:outline-none bg-gray-100 focus:ring-2 focus:ring-blue-600 focus:border-transparent rounded-md" name="" id="" placeholder="Write Task Description" cols={30} rows={5}></textarea>
                </div>
